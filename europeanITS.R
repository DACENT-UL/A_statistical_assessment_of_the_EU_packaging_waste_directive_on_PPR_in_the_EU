...
legend("topleft",
       legend = c("Observed", "Fitted ITS", "Intervention (2007)"),
       col = c("black", "red", "red"),
       lty = c(1, 1, 1),     # line types
       pch = c(1, 1, NA),    # point symbols (NA for abline)
       lwd = c(1, 1, 1))
...
legend("topleft",
       legend = c("Observed", "Trend Line", "Intervention (2007)"),
